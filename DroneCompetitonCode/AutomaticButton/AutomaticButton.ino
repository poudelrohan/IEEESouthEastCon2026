// ══════════════════════════════════════════════════════════════
//  TELLO AUTOMATIC BUTTON — SINGLE FLIGHT, LONGER PAUSES
//
//  Same as Shortcut17 but with longer stabilize/pause times.
//
//  T=35s: Takeoff + 5s stabilize
//         → fwd 40 + 2s pause → CW 180 + 2s pause
//         → fwd 30 + 2s pause → CW 180 + 2s pause
...
// ─────────────── TIMING ───────────────
unsigned long TAKEOFF_TIME = 35000;   // T=35s: takeoff after 35s from power-on
...
void setup() {
    ...
    Serial.println("\n\n==========================================================");
    Serial.println("   TELLO AUTOMATIC BUTTON — SINGLE FLIGHT");
    Serial.println("==========================================================\n");

    Serial.println("SEQUENCE:");
    Serial.printf("  T=%lus:    Takeoff + %ds stabilize\n", TAKEOFF_TIME / 1000, STABILIZE_AFTER_TAKEOFF / 1000);
    Serial.printf("            → fwd %d + %ds → CW 180 + %ds\n",
                  MOVE_AWAY_DISTANCE, PAUSE_AFTER_MOVE / 1000, PAUSE_AFTER_MOVE / 1000);
    Serial.printf("            → fwd %d + %ds → CW 180 + %ds\n",
                  RETURN_DISTANCE, PAUSE_AFTER_MOVE / 1000, PAUSE_AFTER_MOVE / 1000);
