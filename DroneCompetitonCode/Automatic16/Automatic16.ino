// ══════════════════════════════════════════════════════════════
//  TELLO AUTOMATIC 16 — CENTER FIRST, THEN DESCEND
//
//  Updated timing to match new robot schedule.
//  Centers at current height BEFORE descending.
//
//  ROBOT SCHEDULE:
//    T=0-17s:   Delay (ESP connects WiFi + SDK)
//    T=17-27s:  Robot → middle-left (10s)
//    T=27-44s:  Robot stays at middle-left (17s)
//    T=44-58s:  Robot → crater (14s)
//    T=58-88s:  Robot inside crater (30s)
//    T=88-106s: Robot → middle-left (18s)
//    T=106-116s: Robot → starting place (10s)
//
//  DRONE TIMELINE:
//    T=0s:   ESP boots, connects WiFi + SDK mode
//    T=27s:  Takeoff → fwd 40 → CW 180 → fwd 40 → CW 180 → land
//    T=~59s: On ground. Robot heading to crater.
//    T=86s:  Takeoff 2 → right 20 → hover (before robot returns)
//    T=116s: Robot at start. Center + descend + land on pad
//
...
unsigned long TAKEOFF_2_TIME = 86000;   // T=86s: second takeoff (2s before robot leaves crater)
unsigned long LAND_PHASE_TIME = 116000; // T=116s: robot arrives at start, begin precision landing
...
void setup() {
    ...
    Serial.println("\n\n==========================================================");
    Serial.println("   TELLO AUTOMATIC 16 -- CENTER FIRST, THEN DESCEND");
    Serial.println("==========================================================\n");
