...
void HW_Board::begin() {
  ...
  ledcSetup(LEDC_CHANNEL_0, LEDC_BASE_FREQ, LEDC_TIMER_BIT); // 5kHz frequency, 8-bit resolution (5kHz 频率, 8位分辨率)
